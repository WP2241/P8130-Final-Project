...
summary_losdays2 = hos_tidy %>% 
  select(losdays2) %>%
>>>>>>> c19279c51862029fbf2f7e3e41603e0f91891266
...
=======
summary_respirationrate = hos_tidy %>% 
  select(respirationrate) %>%
>>>>>>> c19279c51862029fbf2f7e3e41603e0f91891266
  summarize(variable = names(.),
...
boot.fn(hos_tidy_omitna_outl,1:3431)


set.seed(1)


boot.fn(hos_tidy_omitna_outl,sample(3431,3431,replace=T))
